...
ax = plt.axes()
heat_map = t.temp_vis(zoom_x, zoom_y, map_file='../processed_data/future_tmap.csv')
fish_map = t.fish_vis(fish_temp, 0.3,zoom_x, zoom_y,fish, map_file='../processed_data/future_tmap.csv',cmap='Greys')
